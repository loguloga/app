...
<div>
    ...
    <a href="{{ url('user/verify', $verification_status)}}">Confirm my email address </a>
...
<body marginheight=0 marginwidth=0 topmargin=0 leftmargin=0 style="height: 100% !important; margin: 0; padding: 0; width: 100% !important;min-width: 100%;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" name="bmeMainBody" style="background-color: rgb(239, 245, 249);" bgcolor="#eff5f9">
        <tbody>
            <tr>
                                                            ...
                                                            <tr>
                                                                <td width="100%" class="blk_container bmeHolder bmeBody" name="bmeBody" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 255, 255);" bgcolor="#ffffff">
                                                                    ...
                                                                    <div id="dv_19" class="blk_wrapper" style="">
                                                                        <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_divider" style="background-color: rgb(239, 245, 249);">
                                                                            <tbody>
                                                                                <tr>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 125%; text-align: center;"><span style="font-size: 36px; font-family: Georgia, Palatino; color: #bb392f; line-height: 125%;">    
<em>Find The Below Link For Registration</em></span>
                                                                                                                            <br><span style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; color: #cbd0d4; line-height: 125%;">__________</span></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                    ...
                                                                    <div id="dv_16" class="blk_wrapper" style="">
                                                                        <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text">
                                                                            <tbody>
                                                                            <div style="line-height: 125%; text-align: center;"><span style="font-size: 14px; font-family: Georgia, Palatino; color: #bb392f; line-height: 125%;">    
                                                                            <em> Hi {{ $name }},</em>
                                                                            </div>
                                                                                <tr>
                                                                                    <td>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 5px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 200%; text-align: center;"><span style="font-size: 14px; font-family: Georgia, Palatino; color: #666666; line-height: 200%;">    
<em>You had to be excited enough about something to decide to send this email campaign. This is where that news goes. Think of it as your mountaintop to shout from.</em></span></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <!-- <td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;"><span style="font-size: 18px; font-family: Georgia, Palatino; color: #666666; line-height: 150%;">Here's your personal code: DIS4873005</span></div>
                                                                                                                    </td> -->
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    ...
                                                                                                    <td align="center">
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td style="border-radius: 0px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: normal; background-color: rgb(187, 57, 47);" class="bmeButtonText"><span style="font-family: Georgia, Palatino; font-size: 20px; color: rgb(255, 255, 255);">    
<a href="{{ url('user/verify', $verification_status)}}" style="color:#FFFFFF;text-decoration:none;" target="_blank">CLICK HERE</a></span></td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    </td>
                                                                    ...
                                                                    <div id="dv_24" class="blk_wrapper" style="">
                                                                        <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_divider" style="background-color: rgb(226, 226, 226);">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="tblCellMain" style="padding: 0px 0px 10px;">
                                                                                        <table class="tblLine" cellspacing="0" cellpadding="0" border="0" width="100%" style="border-top-width: 40px; border-top-style: solid; min-width: 1px; border-top-color: rgb(255, 255, 255);">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td><span></span></td>
                                                                                                </tr>
                                                            ...
                                                            <tr>
                                                                <td width="100%" class="blk_container bmeHolder" name="bmePreFooter" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(239, 245, 249);" bgcolor="#eff5f9">
                                                                                                    ...
                                                                                                    <td class="tdPart" valign="top" align="center">
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 125%; text-align: center;"><span style="font-size: 24px; font-family: Georgia, Palatino; color: #bb392f; line-height: 125%;">    
<em>About Us</em></span>
                                                                                                                            <br><span style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; color: #cbd0d4; line-height: 125%;">__________</span></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                        ...
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 5px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 200%; text-align: center;"><span style="font-size: 14px; font-family: Georgia, Palatino; color: #666666; line-height: 200%;">    
<em>Any business, especially in which “the customer” pans out to be an axiomatic asset, is subjected to take part in the digital transformation race. However, one need not be innately proficient to deploy technology; the rightful alliance is just what it takes in gaining a competitive edge.</em></span></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
...
<em>Contact Us</em></span>
                                                                                                        ...
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 5px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 200%; text-align: center;"><span style="font-size: 14px; font-family: Georgia, Palatino; color: #666666; line-height: 200%;">    
                                                                                                                        <a href="https://www.qrsolutions.com.au/" target="_blank">                                                                                                                        <em>www.qrsolutions.com.au</em></span></div>
                                                                                                                        </a>
                                                                    ...
                                                                    <div id="dv_7" class="blk_wrapper" style="">
                                                                        <table cellspacing="0" cellpadding="0" border="0" style="" name="blk_social_follow" width="600" class="blk">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="tblCellMain" align="center" style="padding: 5px 20px;">
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="10" width="24" style="padding-right:10px;height:20px;">
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=5EE6FDB&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1" target=_blank style="display: inline-block;background-color: rgb(53, 91, 161);border-radius: 28px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="https://ui.benchmarkemail.com/images/editor/socialicons/fb_btn.png" alt="Facebook" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                        <!--[if gte mso 6]></td><td align="left" valign="top"><![endif]-->
                                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeFollowItem" type="googleplus" style="float: left; display: block;" align="left">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="10" width="24" style="padding-right:10px;height:20px;">
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=5EE6FDC&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1" target=_blank style="display: inline-block;background-color: rgb(214, 73, 46);border-radius: 28px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="https://ui.benchmarkemail.com/images/editor/socialicons/gp_btn.png" alt="Google Plus" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="10" width="24" style="height:20px;">
                                                                                                                                        <a href="http://benchmarkemail.benchurl.com/c/l?u=5EE6FDD&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1" target=_blank style="display: inline-block;background-color: rgb(50, 203, 255);border-radius: 28px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="https://ui.benchmarkemail.com/images/editor/socialicons/tw_btn.png" alt="Twitter" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                            ...
                                            <!-- <tr>
                                                <td width="100%" class="blk_container bmeHolder" name="bmeFooter" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent;" bgcolor="">
                                                                ...
                                                                <tr>
                                                                    <td name="tblCell" class="tblCell" style="padding:20px;" valign="top" align="left">
                                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td name="bmePermissionText" style="text-align:left;" align="left"><span style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 11px;line-height: 140%;">    
                                                                ...
                                                                <tr>
                                                                    <td name="tblCell" class="tblCell" style="padding:20px;" valign="top" align="left">
                                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td name="bmeBadgeText" style="text-align:left; word-break: break-word;" align="left"><span id="spnFooterText" style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 11px; line-height: 140%;">This message was sent to amilcar.cruz@benchmarkemail.com by benchmarkdesignsystem.gmail.com@email.benchmarkapps.com    
 ...
 src="https://www.benchmarkemail.com/images/verified.png" alt="Unsubscribe from all mailings" title="Unsubscribe from all mailings" border="0"></span>
                                                                                ...
                                                                                <tr>
                                                                                    <td name="bmeBadgeImage" style="text-align: left; padding-top: 20px; word-break: break-word;" align="left">
                                                                                        <a href="http://www.benchmarkemail.com?p=500289" target="_new"><img src="https://www.benchmarkemail.com/images/web4/misc/emailfooter/opt12.png" style="max-width:144px;" border=0 /></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
